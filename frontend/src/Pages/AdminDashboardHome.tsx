...
function AdminDashboardHome() {
  ...
  // Calculate total token supply across all properties (reusing valuation as in reference)
        ...
        {loading ? (
          <div className="grid md:grid-cols-2 gap-4">
            {[...Array(4)].map((_, i) => (
              <div
                key={i}
                className="rounded-xl border border-[#1f1f1f] bg-[#0f0f0f] p-4 animate-pulse"
              >
                ...
                <div className="flex items-start justify-between mb-3">
                  <div>
                    ...
                    <p className="text-xs text-gray-400">
                      Owner: {property.OwnerWallet.substring(0, 6)}...
