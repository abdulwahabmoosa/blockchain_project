...
const faqs = [
    ...
    {
        question:
            "What documents do I need to sell my property through Propchain?",
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-sm text-gray-400 max-w-xl">
                                Read the success stories and heartfelt
                    ...
                    <div className="relative">
                        ...
                        <div className="flex gap-3 justify-end pt-3">
                            <Button
                                ...
                                className="border-[#262626] bg-[#111111] text-white hover:bg-[#1a1a1a]"
                                onClick={() =>
                                    scrollCarousel(testimonialRef, -1)
                                }
                            >
                                ←
                            </Button>
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-sm text-gray-400 max-w-xl">
                                ...
                                Propchain&apos;s services, property listings,
                    ...
                    <div className="rounded-3xl border border-[#1f1f1f] bg-[#0e0e0e] p-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                        <div className="space-y-2 max-w-3xl">
                            ...
                            <p className="text-sm text-gray-300 leading-relaxed">
                                ...
                                advice, Propchain is here to assist you every
                                step of the way.
                            </p>
                        </div>
                        <Button
