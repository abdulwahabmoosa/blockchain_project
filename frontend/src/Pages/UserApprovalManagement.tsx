          ...
          try {
            ...
            if (!blockchainApproved) {
              ...
              // If no persisted approval, check database status as fallback
                ...
                console.log(`💾 Blockchain check failed for ${user.Email}, but database shows approved. Using database status.`);
              ...
              else if (pendingApprovals[user.WalletAddress]) {
                ...
                results.push({ ...user, blockchainApproved: false, pendingConfirmation: false });
              }
            } else {
            ...
            if (persistedStatus === true) {
              ...
              results.push({ ...user, blockchainApproved: true, pendingConfirmation: false });
            } else if (user.blockchainApproved === true) {
